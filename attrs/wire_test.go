...
func TestOrigin_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00}, cps, meta.Meta{})
...
func TestU32_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00, 0x03, 0xE8}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestNextHop_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{192, 0, 2, 1}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestAspath_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x02, 0x02, 0xFD, 0xE9, 0x00, 0x64}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestAspath_AS4_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x02, 0x01, 0x00, 0x00, 0xFD, 0xE9}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestAggregator_AS4_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00, 0xFD, 0xE9, 192, 0, 2, 1}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestCommunity_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x64, 0x00, 0x01, 0x00, 0xC8, 0x00, 0x02}, cps, meta.Meta{})
	require.NoError(t, err)
	require.Equal(t, 2, at.Len())
...
func TestMPReachUnreach_Wire(t *testing.T) {
	...
	err := atr.Unmarshal(reachVal, cps, meta.Meta{})
	require.NoError(t, err)
	...
	reachBuf := atr.Marshal(nil, cps, meta.Meta{})
	...
	err = atu.Unmarshal(unreachVal, cps, meta.Meta{})
	require.NoError(t, err)
	...
	unreachBuf := atu.Marshal(nil, cps, meta.Meta{})
...
func TestAspath_EmptyPath_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestAspath_ASSet_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x01, 0x02, 0x00, 0x64, 0x00, 0xC8}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestOrigin_AllValues_Wire(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			at := NewAttr(ATTR_ORIGIN).(*Origin)
			err := at.Unmarshal([]byte{tt.value}, cps, meta.Meta{})
			require.NoError(t, err)
...
func TestCommunity_WellKnown_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0xFF, 0xFF, 0xFF, 0x01}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestRaw_Attr_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0xDE, 0xAD, 0xBE, 0xEF}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestU32_MED_Max_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00, 0x00, 0xff}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestU32_LocalPref_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00, 0x00, 0x0a}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestOriginatorID_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x0a, 0x00, 0x00, 0x04}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestClusterList_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x0a, 0x00, 0x00, 0x03}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestOTC_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00, 0x04, 0xd2}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestOTC_InvalidLength_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00, 0x00}, cps, meta.Meta{})
	require.Error(t, err)

	err = at.Unmarshal([]byte{0x00, 0x00, 0x00, 0x00, 0x00}, cps, meta.Meta{})
	require.Error(t, err)
}
...
func TestOTC_MaxASN_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0xFF, 0xFF, 0xFF, 0xFF}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestNextHop_Routecore_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x01, 0x02, 0x03, 0x04}, cps, meta.Meta{})
	require.NoError(t, err)
...
func TestOrigin_InvalidLength_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x00, 0x00}, cps, meta.Meta{})
	require.Error(t, err)
...
func TestNextHop_InvalidLength_Wire(t *testing.T) {
	...
	err := at.Unmarshal([]byte{0x01, 0x02, 0x03}, cps, meta.Meta{})
	require.Error(t, err)
}
